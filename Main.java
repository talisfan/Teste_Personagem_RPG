public class Main {
    private static void testarPersonagem(){
        ...
        // Niveis máximos
        p.adicionarXP(2500);
        testesCorretos += rodarTeste("não é possÃ­vel passar do nível 25",p.getNivel() == 25);
        ...
        p.consumirPocao();
        p.consumirPocao();
        // mesmo os 500 de mana não sÃ£o suficientes para usar a ult no nivel 3 (200*3 = 600)
